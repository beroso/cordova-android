    ...
    prepEnv (opts) {
        ...
        return check_reqs.check_gradle()
            .then(function () {
                ...
                fs.copySync(path.join(self.root, 'tools', 'gradle'), path.join(self.root, 'gradle'));
                fs.copySync(path.join(self.root, 'tools', 'gradlew'), path.join(self.root, 'gradlew'));
                fs.copySync(path.join(self.root, 'tools', 'gradlew.bat'), path.join(self.root, 'gradlew.bat'));
                fs.copySync(path.join(self.root, 'tools', '.gradle'), path.join(self.root, '.gradle'));
            }).then(function () {
                ...
                if (opts.packageInfo) {
                    ...
                    fs.removeSync(signingPropertiesPath, { force: true });
                }
            });
    }
